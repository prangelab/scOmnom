...
def load_and_qc(
    ...
    min_genes_prefilter: int = typer.Option(50, help="Prefilter: remove barcodes with fewer genes before QC"),
    min_umis_prefilter: int = typer.Option(20, help="Prefilter: remove barcodes with fewer UMIs before QC"),
