            ...
            def _run_method(
                ...
                if tag == "sccoda":
                    ...
                    res, milo_meta, milo_regions, milo_region_samples, milo_coverage = run_milo_da(
                        ...
                        n_seeds=int(_milo_setting("composition_milo_n_seeds", "composition_graph_n_seeds", 1000)),
                        k_ref=int(_milo_setting("composition_milo_k_ref", "composition_graph_k_ref", 75)),
                        max_k=int(getattr(cfg, "composition_graph_max_k", None) or 200),
                        min_size=int(_milo_setting("composition_milo_min_size", "composition_graph_min_size", 50)),
                        random_state=int(
        ...
        if write_settings:
            _write_settings(
                ...
                [
                    ...
                    f"milo_n_seeds={_milo_setting('composition_milo_n_seeds', 'composition_graph_n_seeds', 1000)}",
                    f"milo_k_ref={_milo_setting('composition_milo_k_ref', 'composition_graph_k_ref', 75)}",
                    f"milo_min_size={_milo_setting('composition_milo_min_size', 'composition_graph_min_size', 50)}",
