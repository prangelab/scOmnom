...
def generate_annotated_integration_report(
    *,
    ...
    pre_short_path = _find_first_all([f"umap_pre_{tag}", "_shortlegend"], exclude=["_batch"])
    post_short_path = _find_first_all([f"umap_post_{tag}", "_shortlegend"], exclude=["_batch"])
