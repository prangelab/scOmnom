...
7. `de`
8. `da`
9. optional `enrichment cluster` (descriptive profiles), `enrichment de` (DE-statistic enrichment), or pre-release `enrichment sample` (replicate-level activity contrasts; biological validation pending)
10. optional `ccc ...`
