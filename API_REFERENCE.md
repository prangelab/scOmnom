...
Sample-level enrichment is currently CLI-only through `scomnom enrichment sample`; no sample-enrichment function is exported in these Python namespaces. See `docs/markers-and-de/enrichment.md` for its pre-release status and options.
