...
2. **Structural selection**
   Candidate resolutions are scored using adjacent-resolution stability, centroid-based silhouette separation, and the small-cluster safeguard score. No global cluster-count penalty is subtracted from the silhouette score.
