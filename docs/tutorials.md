...
| [Kang IFN-beta PBMC DE](tutorials/kang-ifnb-de.md) | Replicate-aware DE, enrichment, differential abundance, condition-split LIANA CCC, and a paired sample-activity example. | Use after the processing tutorial when you want condition-aware downstream analysis. |
